...
(c) 2026 Julius Brussee — Business Source License 1.1 (LICENSE.BSL upstream).
Used here for internal evaluation / local development per the Additional Use Grant.
-->
---
name: caveman
description: >
